...
#SBATCH --job-name=bcti_causal_only
...
#SBATCH --chdir=.
#SBATCH --output=./comp/BCTI-baselines/bcti_causal_only-%j.out
#SBATCH --error=./comp/BCTI-baselines/bcti_causal_only-%j.err
...
CONFIG="${CONFIG:-comp/BCTI-baselines/config_causal_score_only.yaml}"
OUT_ROOT="${OUT_ROOT:-outputs/50-targets/ablation/internal/BCTI-main-ablation-causal-score-only-unified-audit}"
