...
#SBATCH --chdir=.
#SBATCH --output=./comp/BCTI-baselines/bcti_rev_loc-%j.out
#SBATCH --error=./comp/BCTI-baselines/bcti_rev_loc-%j.err
...
CONFIG="${CONFIG:-comp/BCTI-baselines/config_reverse_only_localization.yaml}"
OUT_ROOT="${OUT_ROOT:-outputs/50-targets/ablation/internal/BCTI-main-ablation-reverse-only-localization-unified-audit}"
