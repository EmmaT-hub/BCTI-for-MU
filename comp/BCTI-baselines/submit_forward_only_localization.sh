...
#SBATCH --chdir=.
#SBATCH --output=./comp/BCTI-baselines/bcti_fwd_loc-%j.out
#SBATCH --error=./comp/BCTI-baselines/bcti_fwd_loc-%j.err
...
CONFIG="${CONFIG:-comp/BCTI-baselines/config_forward_only_localization.yaml}"
OUT_ROOT="${OUT_ROOT:-outputs/50-targets/ablation/internal/BCTI-main-ablation-forward-only-localization-unified-audit}"
